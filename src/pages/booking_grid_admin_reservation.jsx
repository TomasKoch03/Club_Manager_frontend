...
import {getCourts, getReservationsBySportAndDay, postReservationForUser, postPayment} from "../services/api.js";
...
const BookingGridAdmin = () => {
    ...
    const handlePayInClub = async () => {
        ...
        try {
            const data = await postReservationForUser(userId, {
...
export default BookingGridAdmin;